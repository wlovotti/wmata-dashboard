...
- [NOTES-99](notes/NOTES-99.md) Agency comparison page (the north star) — sev high / eff medium — unblocked (SFMTA backfill done 2026-08-09; owl-route service-date fix landed PR #192, SFMTA re-derive (PR #192's migration steps) + EWT/bunching re-derive pending PR #191)
