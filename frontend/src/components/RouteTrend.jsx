 ...
 * essentially-unchanged metrics. `lowerIsBetter=true` flips the color
 * mapping (up = bad, down = good) for metrics like EWT, bunching, and
 * excess-trip-time where a higher value means worse service. The arrow
 * direction always reflects the raw sign of the delta — only the color
 * encodes "good vs bad" — so a tooltip-readable "+0.5pp" stays accurate
 * regardless of which direction is desirable.
 */
